...
class DrawingClassifier:
    ...
    #     self.canvas.create_line(x1, y1, x2, y2, fill="black", width=self.brushWidth)
    #     self.draw.line([x1, y1, x2 + self.brushWidth, y2 + self.brushWidth], fill="black", width=self.brushWidth)
